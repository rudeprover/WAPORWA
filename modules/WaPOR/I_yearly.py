# -*- coding: utf-8 -*-
"""
Yearly Interception from WaPOR v3 (L1-I-A / L2-I-A)

This is a v3 replacement of the original v2-based I_yearly module.
"""
...
def main(Dir,
         ...
         Waitbar=1):
    """
    Download yearly WaPOR v3 Interception for given period and bbox.
    ...
    level : int
        1 for L1-I-A (continental), 2 for L2-I-A (national)
    version : int
    ...
    print(f"\nDownload yearly WaPOR v3 Interception data ({mapset_code}) "
    ...
    for dt, code, url in selected:
        fname = 'I_WAPOR.v3_level{}_mm-year-1_annually_{:04d}.tif'.format(
            level, dt.year
        )
    ...
    print(f"\nFinished downloading WaPOR v3 yearly Interception ({mapset_code})")
    return out_dir